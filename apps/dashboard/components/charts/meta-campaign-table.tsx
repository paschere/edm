      ...
      <Table>
        <TableHeader>
          <TableRow style={{ borderColor: "rgba(11,8,5,0.07)" }}>
            ...
            <TableHead className="text-right text-[11px] uppercase tracking-wider text-muted-foreground font-medium">Impresiones</TableHead>
            <TableHead className="text-right text-[11px] uppercase tracking-wider text-muted-foreground font-medium">CTR</TableHead>
            <TableHead className="text-right text-[11px] uppercase tracking-wider text-muted-foreground font-medium">CPC</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {campaigns.map((c) => (
            <TableRow key={c.id} style={{ borderColor: "rgba(11,8,5,0.05)" }}>
              <TableCell className="text-[13px] font-medium max-w-[200px] truncate text-foreground">
                {c.name}
              </TableCell>
              <TableCell>
                <span
                  ...
                  style={
                    c.status === "ACTIVE"
                      ? {
                          background: "rgba(79,122,62,0.1)",
                          color: "#4f7a3e",
                          border: "1px solid rgba(79,122,62,0.2)",
                        }
                      : {
                          background: "rgba(11,8,5,0.05)",
                          color: "#a69880",
              ...
              <TableCell className="text-right metric text-[12px] tabular-nums">
                <span
                  style={{
                    color:
                      c.roas >= 2 ? "#4f7a3e" : c.roas > 0 ? "#bb9a4c" : "#a69880",
                    fontWeight: c.roas >= 2 ? 600 : 400,
                  }}
                >
